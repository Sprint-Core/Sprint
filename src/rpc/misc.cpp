...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"     (string, required) The sprint address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The sprint address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"")
            + HelpExampleRpc("validateaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"")
        );
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The sprint address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"]}")
        );
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"]}")
        );
...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1 || !request.params[0].isObject())
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"]}")
        );
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"]}")
        );
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"]}")
        );
