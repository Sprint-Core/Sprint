    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  sprx-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Sprx in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SPRX, 0.1 SPRX, 1 SPRX and 10 SPRX -- sort of like the paper money you use every day.</li> \
