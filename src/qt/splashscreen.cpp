    ...
    QWidget(0, f), curAlignment(0)
{
	...
	QString copyrightText  = QChar(0xA9)+QString(" 2019-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Sprint Core Developers"))+ QString("\n") + 
							 QChar(0xA9)+QString(" 2014-2018 ") + QString(tr("The Dash Core Developers"))+ QString("\n") + 
							 QChar(0xA9)+QString(" 2009-2018 ") + QString(tr("The Bitcoin Core Developers"));
