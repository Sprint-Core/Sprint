...
// Copyright (c) 2019-2020 The Sprint Core developers
...
UniValue getnewaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "\"address\"    (string) The new sprint address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "\"address\"          (string) The account Sprx address\n"
            "\nExamples:\n"
...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The sprint address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\", \"tabby\"")
        );
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The sprint address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"")
            + HelpExampleRpc("getaccount", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"")
        );
...
UniValue getaddressesbyaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"address\"         (string) a sprint address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"            (string, required) The sprint address to send to.\n"
            ...
            "                             The recipient will receive less amount of SPRX than you enter in the amount field.\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue listaddressgroupings(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"address\",            (string) The sprint address\n"
...
UniValue listaddressbalances(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"address\": amount,       (string) The sprint address and the amount in " + CURRENCY_UNIT + "\n"
            "  ,...\n"
            "}\n"
            "\nExamples:\n"
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"address\"         (string, required) The sprint address to use for the private key.\n"
            ...
            + HelpExampleCli("signmessage", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The sprint address for transactions.\n"
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            "                       the spend.\n"
            "2. \"toaddress\"         (string, required) The sprint address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "                           Those recipients will receive less sprxs than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\\\":0.01,\\\"Schg63PC6k9WsQjQe2zu9L6S6wMFzDCYFp\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\\\":0.01,\\\"Schg63PC6k9WsQjQe2zu9L6S6wMFzDCYFp\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\\\":0.01,\\\"Schg63PC6k9WsQjQe2zu9L6S6wMFzDCYFp\\\":0.02}\", 6, false, \"testing\"")
        );
    ...
    BOOST_FOREACH(const std::string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Sprint address: ")+name_);
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
    {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "2. \"keys\"         (string, required) A json array of sprint addresses or hex-encoded public keys\n"
            "     [\n"
            ...
            "\nResult:\n"
            "\"address\"         (string) A sprint address associated with the keys.\n"
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The sprint address of the transaction. Not present for \n"
...
UniValue listsinceblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The sprint address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "      \"address\" : \"address\",          (string) The sprint address involved in the transaction\n"
...
UniValue walletpassphrase(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() < 2 || request.params.size() > 3))
        throw std::runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending sprxs\n"
            "\nArguments:\n"
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 0))
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\" 1.0") +
...
UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (!pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 1))
        throw std::runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending sprx\n"
    ...
    StartShutdown();
    return "Wallet encrypted; Sprint Core server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending sprxs.\n"
...
UniValue getwalletinfo(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            + (!fLiteMode ?
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized sprx balance of the wallet in " + CURRENCY_UNIT + "\n" : "") +
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of sprx addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) sprx address\n"
            "      ,...\n"
            "    ]\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the sprx address\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\\\",\\\"Schg63PC6k9WsQjQe2zu9L6S6wMFzDCYFp\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"Sb2tv1Fap1NTrpynerUXiqo5v4v45Coy6q\\\",\\\"Schg63PC6k9WsQjQe2zu9L6S6wMFzDCYFp\\\"]\"")
        );
    ...
    if (request.params.size() > 2 && !request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Sprint address: ")+input.get_str());
            if (setAddress.count(address))
...
UniValue fundrawtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
                            ...
                            "   {\n"
                            "     \"changeAddress\"          (string, optional, default pool address) The sprx address to receive the change\n"
                            ...
                            "                              Those recipients will receive less sprx than you enter in their corresponding amount field.\n"
    ...
    if (request.params.size() > 1) {
      if (request.params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_PARAMETER, "changeAddress must be a valid sprint address");
